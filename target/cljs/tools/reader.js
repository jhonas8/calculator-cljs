...
var G__4802 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch = G__4802;
continue;
}
break;
...
return cljs.tools.reader.read_tagged.call(null,(function (){var G__4803 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4803,ch);
...
if(("\\" === ch__$1)){
var ch_4804__$2 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
if((ch_4804__$2 == null)){
cljs.tools.reader.impl.errors.throw_eof_reading.call(null,rdr,new cljs.core.Keyword(null,"regex","regex",939488856),sb);
} else {
}

sb.append(ch_4804__$2);
} else {
}

var G__4805 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
ch__$1 = G__4805;
continue;
}
}
...
if(cljs.core.truth_((function (){var or__4160__auto__ = cljs.tools.reader.impl.utils.whitespace_QMARK_.call(null,ch);
if(or__4160__auto__){
return or__4160__auto__;
} else {
var or__4160__auto____$1 = cljs.tools.reader.macros.call(null,ch);
...
var vec__4813 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4813,(0),null);
var start_column = cljs.core.nth.call(null,vec__4813,(1),null);
...
var G__4816 = cljs.core.conj_BANG_.call(null,a,form);
a = G__4816;
continue;
}
}
...
var _STAR_read_delim_STAR__orig_val__4817 = cljs.tools.reader._STAR_read_delim_STAR_;
var _STAR_read_delim_STAR__temp_val__4818 = true;
(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__temp_val__4818);

try{return cljs.tools.reader.read_delimited_internal.call(null,kind,delim,rdr,opts,pending_forms);
}finally {(cljs.tools.reader._STAR_read_delim_STAR_ = _STAR_read_delim_STAR__orig_val__4817);
}});
/**
 * Read in a list, including its location if the reader is an indexing reader
 */
cljs.tools.reader.read_list = (function cljs$tools$reader$read_list(rdr,_,opts,pending_forms){
var vec__4819 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4819,(0),null);
var start_column = cljs.core.nth.call(null,vec__4819,(1),null);
...
var vec__4822 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4822,(0),null);
var end_column = cljs.core.nth.call(null,vec__4822,(1),null);
...
var vec__4825 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4825,(0),null);
var start_column = cljs.core.nth.call(null,vec__4825,(1),null);
...
var vec__4828 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4828,(0),null);
var end_column = cljs.core.nth.call(null,vec__4828,(1),null);
...
var vec__4831 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4831,(0),null);
var start_column = cljs.core.nth.call(null,vec__4831,(1),null);
...
var vec__4834 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4834,(0),null);
var end_column = cljs.core.nth.call(null,vec__4834,(1),null);
...
var sb = (function (){var G__4837 = (new goog.string.StringBuffer());
G__4837.append(initch);
...
var or__4160__auto__ = cljs.tools.reader.impl.commons.match_number.call(null,s);
...
var G__4839 = (function (){var G__4838 = sb;
G__4838.append(ch);

return G__4838;
})();
var G__4840 = cljs.tools.reader.reader_types.read_char.call(null,rdr);
sb = G__4839;
ch = G__4840;
continue;
}
...
switch (G__4843) {
case "\\":
var G__4847 = (function (){var G__4844 = sb;
G__4844.append(cljs.tools.reader.escape_char.call(null,sb,reader));

return G__4844;
})();
var G__4848 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4847;
ch = G__4848;
continue;
...
break;
default:
var G__4849 = (function (){var G__4845 = sb;
G__4845.append(ch);

return G__4845;
})();
var G__4850 = cljs.tools.reader.reader_types.read_char.call(null,reader);
sb = G__4849;
ch = G__4850;
continue;
...
var vec__4851 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4851,(0),null);
var end_column = cljs.core.nth.call(null,vec__4851,(1),null);
...
var vec__4854 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4854,(0),null);
var column = cljs.core.nth.call(null,vec__4854,(1),null);
...
var or__4160__auto__ = cljs.tools.reader.resolve_alias.call(null,sym);
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
...
var vec__4859 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4859,(0),null);
var column = cljs.core.nth.call(null,vec__4859,(1),null);
...
var m__$1 = (cljs.core.truth_((function (){var and__4149__auto__ = line;
...
var vec__4864 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var line = cljs.core.nth.call(null,vec__4864,(0),null);
var column = cljs.core.nth.call(null,vec__4864,(1),null);
var m = cljs.tools.reader.impl.utils.desugar_meta.call(null,cljs.tools.reader.read_STAR_.call(null,rdr,true,null,opts,pending_forms));
if(cljs.core.map_QMARK_.call(null,m)){
} else {
cljs.tools.reader.impl.errors.throw_bad_metadata.call(null,rdr,m);
...
var vec__4869 = cljs.tools.reader.starting_line_col_info.call(null,rdr);
var start_line = cljs.core.nth.call(null,vec__4869,(0),null);
var start_column = cljs.core.nth.call(null,vec__4869,(1),null);
...
var vec__4872 = cljs.tools.reader.ending_line_col_info.call(null,rdr);
var end_line = cljs.core.nth.call(null,vec__4872,(0),null);
var end_column = cljs.core.nth.call(null,vec__4872,(1),null);
...
var G__4875 = rdr;
cljs.tools.reader.read_STAR_.call(null,G__4875,true,null,opts,pending_forms);
...
var G__4876 = sym;
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"NaN","NaN",666918153,null),G__4876)){
return Number.NaN;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"-Inf","-Inf",-2123243689,null),G__4876)){
return Number.NEGATIVE_INFINITY;
} else {
if(cljs.core._EQ_.call(null,new cljs.core.Symbol(null,"Inf","Inf",647172781,null),G__4876)){
...
var _STAR_suppress_read_STAR__orig_val__4877 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__4878 = true;
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__4878);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__4877);
}});
...
var G__4879 = cljs.tools.reader.read_STAR_.call(null,rdr,false,cljs.tools.reader.READ_EOF,")",opts,pending_forms);
cljs.tools.reader.check_eof_error.call(null,G__4879,rdr,first_line);

cljs.tools.reader.check_invalid_read_cond.call(null,G__4879,rdr,first_line);

return G__4879;
} else {
var or__4160__auto__ = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
...
var G__4883 = matched;
var G__4884 = cljs.tools.reader.read_suppress.call(null,first_line,rdr,opts,pending_forms);
matched = G__4883;
finished = G__4884;
continue;
} else {
...
if(cljs.core.not.call(null,(function (){var and__4149__auto__ = opts;
if(cljs.core.truth_(and__4149__auto__)){
...
var _STAR_suppress_read_STAR__orig_val__4885 = cljs.tools.reader._STAR_suppress_read_STAR_;
var _STAR_suppress_read_STAR__temp_val__4886 = (function (){var or__4160__auto__ = cljs.tools.reader._STAR_suppress_read_STAR_;
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
...
(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__temp_val__4886);
...
}finally {(cljs.tools.reader._STAR_suppress_read_STAR_ = _STAR_suppress_read_STAR__orig_val__4885);
}}
} else {
return cljs.tools.reader.impl.errors.throw_eof_in_character.call(null,rdr);
}
...
var arg_env_orig_val__4887 = cljs.tools.reader.arg_env;
var arg_env_temp_val__4888 = cljs.core.sorted_map.call(null);
(cljs.tools.reader.arg_env = arg_env_temp_val__4888);

try{var form = cljs.tools.reader.read_STAR_.call(null,(function (){var G__4889 = rdr;
cljs.tools.reader.reader_types.unread.call(null,G__4889,"(");
...
var G__4890 = (i + (1));
var G__4891 = cljs.core.conj_BANG_.call(null,args,(function (){var or__4160__auto__ = cljs.core.get.call(null,cljs.tools.reader.arg_env,i);
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
...
}finally {(cljs.tools.reader.arg_env = arg_env_orig_val__4887);
}});
/**
...
var ch = temp__5802__auto__;
if(cljs.core._EQ_.call(null,"@",ch)){
return cljs.tools.reader.wrapping_reader.call(null,new cljs.core.Symbol("clojure.core","unquote-splicing","clojure.core/unquote-splicing",-552003150,null)).call(null,(function (){var G__4892 = rdr;
cljs.tools.reader.reader_types.read_char.call(null,G__4892);
...
var G__4893 = cljs.core.next.call(null,s__$1);
var G__4894 = ret;
s__$1 = G__4893;
r = G__4894;
continue;
...
var G__4895 = cljs.core.next.call(null,s);
var G__4896 = cljs.core.conj_BANG_.call(null,cljs.core.conj_BANG_.call(null,key_vals,cljs.core.key.call(null,e)),cljs.core.val.call(null,e));
s = G__4895;
key_vals = G__4896;
continue;
} else {
...
var or__4160__auto__ = cljs.core.get.call(null,cljs.tools.reader.gensym_env,sym);
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
...
var gensym_env_orig_val__4901 = cljs.tools.reader.gensym_env;
var gensym_env_temp_val__4902 = cljs.core.PersistentArrayMap.EMPTY;
(cljs.tools.reader.gensym_env = gensym_env_temp_val__4902);
...
}finally {(cljs.tools.reader.gensym_env = gensym_env_orig_val__4901);
}});
...
var temp__5802__auto__ = ((cljs.core._EQ_.call(null,token,":"))?cljs.core.ns_name.call(null,cljs.core._STAR_ns_STAR_):((cljs.core._EQ_.call(null,":",cljs.core.first.call(null,token)))?(function (){var G__4903 = token;
var G__4903__$1 = (((G__4903 == null))?null:cljs.core.subs.call(null,G__4903,(1)));
var G__4903__$2 = (((G__4903__$1 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4903__$1));
var G__4903__$3 = (((G__4903__$2 == null))?null:cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4903__$2));
var G__4903__$4 = (((G__4903__$3 == null))?null:cljs.core.symbol.call(null,G__4903__$3));
if((G__4903__$4 == null)){
return null;
} else {
return cljs.tools.reader.resolve_ns.call(null,G__4903__$4);
}
})():(function (){var G__4904 = token;
var G__4904__$1 = (((G__4904 == null))?null:cljs.tools.reader.impl.commons.parse_symbol.call(null,G__4904));
if((G__4904__$1 == null)){
return null;
} else {
return cljs.tools.reader.impl.utils.second_SINGLEQUOTE_.call(null,G__4904__$1);
}
})()
));
if(cljs.core.truth_(temp__5802__auto__)){
...
var temp__5802__auto__ = (function (){var or__4160__auto__ = cljs.tools.reader._STAR_data_readers_STAR_.call(null,tag);
if(cljs.core.truth_(or__4160__auto__)){
return or__4160__auto__;
} else {
...
}catch (e4911){if((e4911 instanceof Error)){
var e = e4911;
...
(cljs.tools.reader.read.cljs$core$IFn$_invoke$arity$2 = (function (p__4915,reader){
var map__4916 = p__4915;
var map__4916__$1 = cljs.core.__destructure_map.call(null,map__4916);
var opts = map__4916__$1;
var eof = cljs.core.get.call(null,map__4916__$1,new cljs.core.Keyword(null,"eof","eof",-489063237),new cljs.core.Keyword(null,"eofthrow","eofthrow",-334166531));
